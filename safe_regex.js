...
const regex = /<label htmlFor="cl-nama" className="cl-label">[\s\S]*?Ganti lokasi\s*<\/button>\s*<\/motion\.div>/;

const replacementStr = `<form 
                  // @ts-ignore
...
if (regex.test(code)) {
  fs.writeFileSync('components/CekLokasi.tsx', code.replace(regex, replacementStr));
  console.log("Success");
} else {
